...
function register(ts, connection, documents, projects, features, params, languageConfigs) {
    ...
    connection.workspace.onWillRenameFiles((handler) => __awaiter(this, void 0, void 0, function* () {
        const hasTsFile = handler.files.some(file => languageConfigs.definitelyExts.some(ext => file.oldUri.endsWith(ext))
                            ...
                            if (vscode.TextDocumentEdit.is(change)) {
                                for (const file of handler.files) {
                                    if (change.textDocument.uri === file.oldUri) {
                                        ...
                                        change.textDocument.version = (_5 = (_4 = (0, utils_1.getDocumentSafely)(documents, file.newUri)) === null || _4 === void 0 ? void 0 : _4.version) !== null && _5 !== void 0 ? _5 : change.textDocument.version;
                                    }
                                }
                            }
                        }
