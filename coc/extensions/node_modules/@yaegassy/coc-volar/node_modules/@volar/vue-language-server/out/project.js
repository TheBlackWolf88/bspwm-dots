...
function createProject(runtimeEnv, languageConfigs, ts, options, rootPath, tsConfig, tsLocalized, documents, connection, lsConfigs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function getLanguageService() {
            var _a;
            if (!vueLs) {
                vueLs = languageConfigs.createLanguageService({ typescript: ts }, languageServiceHost, runtimeEnv.fileSystemProvide, (uri) => {
                    var _a;
